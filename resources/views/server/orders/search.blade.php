@foreach ($listOrders as $orders)
    <tr>
        ...
        <td>
            <span
                @if ($orders->status_id == 1) style="color: rgb(232, 186, 17);"
        ...
        <td>
            <div class="d-flex align-items-stretch">
                ...
                @if ($orders->status_id == 1)
                    <a data-id="{{ $orders->id }}" class="btn btn-sm btn-outline-primary border me-2"
                        data-bs-toggle="tooltip" data-action="cập nhập trạng thái đơn hàng thành đã duyệt"
                ...
                @elseif ($orders->status_id == 2)
                    <a data-id="{{ $orders->id }}" class="btn btn-sm btn-outline-primary border me-2"
                        data-bs-toggle="tooltip" data-action="cập nhập trạng thái đơn hàng thành đang giao"
                ...
                @elseif($orders->status_id == 4)
                    <a data-id="{{ $orders->id }}" class="btn btn-sm btn-outline-primary border me-2"
                        data-bs-toggle="tooltip" data-action="cập nhập trạng thái đơn hàng thành đã giao"
